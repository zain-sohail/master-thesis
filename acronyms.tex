...
% \newacronym{DESY}{DESY}{Deutsches Elektronen-Synchrotron DESY}
...
\newacronym{MM}{MM}{momentum microscope}
...
\newacronym{PEEM}{PEEM}{photoemission electron microscopy}
...
% \newacronym{as}{a.s.}{almost surely}
% \newacronym{CI}{CI}{confidence interval}
\newacronym{PP}{PP}{point process}
\newacronym[parent=PP]{PPP}{PPP}{Poisson point process}
