...
\begin{figure}
    ...
    \todo[inline]{I don't fully understand where you get the standard deviation from. Please elaborate more in the text what data exactly you use (in particular how many of which type). There seem to be two target images, but I don't see any mention on how many noisy images you use per selected count value.}
