...
Image restoration techniques have been explored in both the spatial and transform domains \cite{buadesReviewImageDenoising2005,diwakarReviewCTImage2018}. For instance, the Fourier transform, and its inverse, are commonly used to map images to and from the frequency domain. A simple way of denoising is to filter out the high frequency components filtered out which are usually noise elements in the transform domain.
